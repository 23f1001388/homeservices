           ...
           <div class="col shadow-lg border p-3">
                ...
                <table class="table responsive">
                    ...
                    <tr v-for="servicerequest in serviceRequests" :key="servicerequest.id">
                        ...
                        <td>
                            <button class="btn btn-primary rounded-3 ms-3 btn-sm" @click="approveServiceRequest(servicerequest.id)"><i class="bi bi-check-circle"> Approve </button>
                            <button class="btn btn-danger rounded-3 ms-3 btn-sm" @click="rejectServiceRequest(servicerequest.id)"><i class="bi bi-x-circle"></i> Reject</button>
                        </td>
                    </tr>
                    </tbody>
